...
public class compressImage {
    ...
    public  File getCompressedImageFile(File file, Context mContext) {
        try {
            ...
            //Hapa ndio panatoa size ya picha in KB,MB
            int scale = 1;
            while (o.outWidth / scale / 20 >= REQUIRED_SIZE &&
                    o.outHeight / scale / 20 >= REQUIRED_SIZE) {
                scale *= 20;
            }
            ...
            File folder = new File(Environment.getExternalStorageDirectory(), DNAME + "/Images");
