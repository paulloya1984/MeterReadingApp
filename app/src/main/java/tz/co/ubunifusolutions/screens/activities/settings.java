...
public class settings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  area = i.getStringExtra("area").trim();
        ...
        ipLocal =(EditText) findViewById(R.id.txtIpLocal);
        ipPublic = (EditText) findViewById(R.id.txtIpPublic);
        txtResult = (TextView) findViewById(R.id.txtResult_Settings);
        btnCancel = (Button) findViewById(R.id.btnClear_Settings);
        btnSave = (Button) findViewById(R.id.btnSave_Settings);
        btnchangeSetting = (Button) findViewById(R.id.btnChange_Settings);
    ...
    public void settingsAdd()
    {
        ...
        try {
            ...
            if (dataBaseHelper.insertSettings(LocalIP, PublicIP)) {
               ...
               // Toast.makeText(this, "Settings Added Successful \n" + "Local IP: " + LocalIP + "\nPublic IP: " + PublicIP, Toast.LENGTH_LONG).show();
                Toast toast = new Toast(getApplicationContext());
                toast.setDuration(Toast.LENGTH_LONG);

                //inflate view
                View custom_view = getLayoutInflater().inflate(R.layout.toast_icon_text, null);
                ((TextView) custom_view.findViewById(R.id.message)).setText("Settings Added Successful \n" + "Local IP: " + LocalIP + "\nPublic IP: " + PublicIP);
               ...
               // Toast.makeText(this, "An Error Has Occoured while adding Settings ", Toast.LENGTH_LONG).show();
                ...
                //inflate view
                View custom_view = getLayoutInflater().inflate(R.layout.toast_icon_text, null);
                ((TextView) custom_view.findViewById(R.id.message)).setText("An Error Has Occoured while adding Settings ");
                ((ImageView) custom_view.findViewById(R.id.icon)).setImageResource(R.drawable.ic_close);
                ((CardView) custom_view.findViewById(R.id.parent_view)).setCardBackgroundColor(getResources().getColor(R.color.red_600));
          ...
          //  Toast.makeText(this, "An Exception Has Occurred \n"+ e.getMessage(), Toast.LENGTH_LONG).show();
            ...
            //inflate view
            View custom_view = getLayoutInflater().inflate(R.layout.toast_icon_text, null);
            ((TextView) custom_view.findViewById(R.id.message)).setText("An Exception Has Occurred \n"+ e.getMessage());
            ((ImageView) custom_view.findViewById(R.id.icon)).setImageResource(R.drawable.ic_close);
            ((CardView) custom_view.findViewById(R.id.parent_view)).setCardBackgroundColor(getResources().getColor(R.color.red_600));
    ...
    public  void okMethod2(){
        ...
        catch (Exception e)
        {
          //  Toast.makeText(this, "An Error Has Occured"+e.getMessage(), Toast.LENGTH_LONG).show();
            ...
            //inflate view
            View custom_view = getLayoutInflater().inflate(R.layout.toast_icon_text, null);
            ((TextView) custom_view.findViewById(R.id.message)).setText("An Error Has Occured"+e.getMessage());
            ((ImageView) custom_view.findViewById(R.id.icon)).setImageResource(R.drawable.ic_close);
            ((CardView) custom_view.findViewById(R.id.parent_view)).setCardBackgroundColor(getResources().getColor(R.color.red_600));
       ...
       // dataBaseHelper.settingDrop();
        ...
        if (res != null && res.getCount() > 0) {
            while (res.moveToNext()) {
                ...
                PublicIPAddress = res.getString(res.getColumnIndex("ip_local"));
            }
...
//            editor.putString("Public IP", PublicIPAddress);
          //  editor.commit();
           // Toast.makeText(settings.this, "Data Retrieved Successfully", Toast.LENGTH_SHORT).show();
            ...
            //inflate view
            View custom_view = getLayoutInflater().inflate(R.layout.toast_icon_text, null);
            ((TextView) custom_view.findViewById(R.id.message)).setText("Data Retrieved Successfully");
           ...
           // Toast.makeText(settings.this, "Data Not Retrieved Successfully", Toast.LENGTH_SHORT).show();
       ...
       // Toast.makeText(this, "Error HAs Occurred"+e.getMessage(), Toast.LENGTH_LONG).show();
